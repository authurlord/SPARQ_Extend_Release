#!/bin/bash
# FetaQA reproduction script for SPARQ-Extend
set -euo pipefail
...
TMP_DIR="results/${MODEL_TAG//./_}/fetaqa"
mkdir -p "${PROJECT_DIR}/${TMP_DIR}"

echo "=== FetaQA Reproduction: ${MODEL_TAG} ==="

CMD="/home/aizoo/miniconda3/envs/hstar/bin/python ${PIPELINE_DIR}/run_full_pipeline_fetaqa.py \
  ...
  --fetaqa_jsonl_path ${SRC_DIR}/datasets/FetaQA/fetaQA-v1_test.jsonl \
  --n_parallel 32 --llm_concurrency 64 \
