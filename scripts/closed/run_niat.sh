#!/bin/bash
# NIAT reproduction script for SPARQ-Extend
set -euo pipefail
...
TMP_DIR="results/${MODEL_TAG//./_}/niat"
mkdir -p "${PROJECT_DIR}/${TMP_DIR}"

echo "=== NIAT Reproduction: ${MODEL_TAG} ==="

CMD="/home/aizoo/miniconda3/envs/hstar/bin/python ${PIPELINE_DIR}/run_full_pipeline_niat.py \
  ...
  --niat_json_path ${SRC_DIR}/datasets/NIAT/niat_4000_filtered.json \
