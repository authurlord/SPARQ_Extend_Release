#!/bin/bash
# TableBench reproduction script for SPARQ-Extend
set -euo pipefail
...
TMP_DIR="results/${MODEL_TAG//./_}/tablebench"
mkdir -p "${PROJECT_DIR}/${TMP_DIR}"

echo "=== TableBench Reproduction: ${MODEL_TAG} ==="

CMD="/home/aizoo/miniconda3/envs/hstar/bin/python ${PIPELINE_DIR}/run_full_pipeline_tablebench.py \
  ...
  --tablebench_jsonl_path ${SRC_DIR}/datasets/TableBench/TableBench.jsonl \
  --n_parallel 32 --llm_concurrency 8 \
